...
exec { "download-esaude-database":
	...
	command	=> "wget https://s3-eu-west-1.amazonaws.com/esaude/esaude-emr/deploy-artifacts/v1.1.0/esaude-clean-database.sql.zip",
...
exec { "download-esaude-war":
	cwd	=> "/esaude/infrastructure/artifacts",
	command	=> "wget https://s3-eu-west-1.amazonaws.com/esaude/esaude-emr/deploy-artifacts/v1.1.0/openmrs.war",
...
exec { "download-esaude-modules":
	cwd	=> "/esaude/infrastructure/artifacts",
	command	=> "wget https://s3-eu-west-1.amazonaws.com/esaude/esaude-emr/deploy-artifacts/v1.1.0/esaude-emr-modules.zip",
